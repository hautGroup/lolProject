...
public final class DateUtil {
	...
	public static Date dateOnly(Date date) {
		return new Date(date.getTime() / MILLISECONDS_A_DAY * MILLISECONDS_A_DAY - 1L * 3600 * 1000 * 8);
	}
	...
	public static void main(String[] args) {
        Date date = new Date();
        System.out.println(DateUtil.date(date, "yyyy-MM-dd hh:mm:ss"));
//		System.out.println(getPaBigActiveTime());
	}
