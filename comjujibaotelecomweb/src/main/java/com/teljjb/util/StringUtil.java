...
public final class StringUtil {
	...
	*/
	...
	public static String transferWord(String word){
		...
		if("".equals(word) || "Japan".equals(word) || word == null){
			name.append("日本");
		}else if("Korea".equals(word)){
			name.append("韩国");
		}else if("France".equals(word)){
			name.append("法国");
		}else if("Germany".equals(word)){
			name.append("德国");
		}else if("Thailand".equals(word)){
			name.append("泰国");
		}else if("Australia".equals(word)){
			name.append("澳洲");
		}else if("American".equals(word)){
			name.append("美国");
		}else if("Italy".equals(word)){
			name.append("意大利");
		}
