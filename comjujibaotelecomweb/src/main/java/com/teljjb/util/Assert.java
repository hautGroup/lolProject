...
public abstract class Assert {
	...
	public static void hasLength(String text) {
		hasLength(text, "[Assertion failed] - this String argument must have "
	...
	public static void hasText(String text) {
		hasText(
				text,
				"[Assertion failed] - "
						+ "this String argument must have text; it cannot be <code>null</code>," +
								" empty, or blank");
	}
	 ...
	 */
	public static void doesNotContain(String textToSearch, String substring) {
		doesNotContain(textToSearch, substring, "[Assertion failed] - "
				+ "this String argument must not contain the substring ["
				+ substring + "]");
	}
	...
	public static void notEmpty(Collection collection) {
		notEmpty(collection, "[Assertion failed] - this collection must "
				+ "not be empty: it must contain at least 1 element");
	}
